...
class GetCartesianPathRequest(genpy.Message):
  _md5sum = "721648200a81dbec003e9f1273aa2c80"
...
Pose pose
"""
  __slots__ = ['header','start_state','group_name','link_name','waypoints','max_step','jump_threshold','prismatic_jump_threshold','revolute_jump_threshold','avoid_collisions','path_constraints']
  _slot_types = ['std_msgs/Header','moveit_msgs/RobotState','string','string','geometry_msgs/Pose[]','float64','float64','float64','float64','bool','moveit_msgs/Constraints']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,start_state,group_name,link_name,waypoints,max_step,jump_threshold,prismatic_jump_threshold,revolute_jump_threshold,avoid_collisions,path_constraints
...
class GetCartesianPath(object):
  ...
  _md5sum = '2f81861c2a157da4ea888c0db053e2a1'
