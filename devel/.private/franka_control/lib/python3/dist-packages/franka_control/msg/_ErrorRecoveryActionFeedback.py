...
"""autogenerated by genpy from franka_control/ErrorRecoveryActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ErrorRecoveryActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "franka_control/ErrorRecoveryActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_control/ErrorRecoveryFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ErrorRecoveryActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = franka_control.msg.ErrorRecoveryFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = franka_control.msg.ErrorRecoveryFeedback()
