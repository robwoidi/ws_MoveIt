...
"""autogenerated by genpy from franka_control/ErrorRecoveryActionResult.msg. Do not edit."""
import codecs
import sys
...
class ErrorRecoveryActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "franka_control/ErrorRecoveryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','franka_control/ErrorRecoveryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ErrorRecoveryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = franka_control.msg.ErrorRecoveryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = franka_control.msg.ErrorRecoveryResult()
